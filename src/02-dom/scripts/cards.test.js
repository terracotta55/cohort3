...
describe("testing DOM manipulation for comp-110", () => {
	beforeEach(() => {
	...
	test("testing appending card buttons", () => {
	...
	test("testing adding new card before current card", () => {
		let testLeft = document.getElementById("leftChild");
		cardsFunctions.createCardDiv();
	...
	test("testing adding new card after current card", () => {
		let testLeft = document.getElementById("leftChild");
		cardsFunctions.createCardDiv();
		let cardCount = testLeft.childElementCount;
