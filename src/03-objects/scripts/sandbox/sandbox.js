...
class AccountController {
  ...
  removeAccount(toBeRemoved) {
    const accountNamesArr = this.accountNamesArr.filter(
      account => account.accountName != toBeRemoved
    );
    this.accountNamesArr = accountNamesArr;
    return this.accountNamesArr;
  }
...
console.log(asyncFunctions.getUsers());
...
class Community {
  ...
  async deleteCity(cityKeyToBeRemoved) {
    this.cityNamesArr = this.cityNamesArr.filter(
      city => city.cityKey !== cityKeyToBeRemoved
    );
  }
}
*/
